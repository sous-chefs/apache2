...
when "windows"
  ...
  default['apache']['conf_dir'] = "#{default['apache']['dir']}/conf.d"
  default['apache']['windows']['display_name'] = "Apache HTTP Server 2.2.25"
  default['apache']['windows']['source'] = "http://apache.cs.utah.edu//httpd/binaries/win32/httpd-2.2.25-win32-x86-openssl-0.9.8y.msi"
  ...
  default['apache']['docroot_dir'] = "#{default['apache']['dir']}/htdocs"
  default['apache']['cgibin_dir'] = "#{default['apache']['dir']}/cgi-bin"
