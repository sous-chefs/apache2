...
describe 'apache2_install' do
  step_into :apache2_module, :apache2_install, :apache_conf, :apache_mod
  platform 'ubuntu'
  ...
  context 'install an apache2_module with default properties' do
    ...
    it 'Creates a LoadModule file with the correct path' do
      ...
      is_expected.to run_execute('a2enconf sed').with_content(%r{/usr/lib/apache2/modules/mod_test.so})
    end
