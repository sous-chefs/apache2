...
RSpec.describe Apache2::Cookbook::Helpers do
  ...
  describe '#default_apache_user' do
    before do
    ...
    context 'with rhel family' do
      ...
      it 'returns the correct path' do
        expect(subject.default_apache_user).to eq 'apache'
      end
    end
    ...
    context 'with SUSE family' do
      ...
      it 'returns the correct path' do
        expect(subject.default_apache_user).to eq 'wwwrun'
      end
    end
    ...
    context 'with Debian' do
      ...
      it 'returns the correct path' do
        expect(subject.default_apache_user).to eq 'www-data'
      end
    end
    ...
    context 'with arch' do
      ...
      it 'returns the correct path' do
        expect(subject.default_apache_user).to eq 'http'
      end
    end
    ...
    context 'with freebsd' do
      ...
      it 'returns the correct path' do
        expect(subject.default_apache_user).to eq 'www'
      end
    end
  end
end
