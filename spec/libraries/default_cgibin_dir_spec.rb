...
RSpec.describe Apache2::Cookbook::Helpers do
  ...
  describe '#default_cgibin_dir' do
    before do
    ...
    context 'with rhel family' do
      ...
      it 'returns the correct path' do
        expect(subject.default_cgibin_dir).to eq '/var/www/cgi-bin'
      end
    end
    ...
    context 'with Debian' do
      ...
      it 'returns the correct path' do
        expect(subject.default_cgibin_dir).to eq '/usr/www/cgi-bin'
      end
    end
    ...
    context 'with arch' do
      ...
      it 'returns the correct path' do
        expect(subject.default_cgibin_dir).to eq '/usr/share/httpd/cgi-bin'
      end
    end
    ...
    context 'with freebsd' do
      ...
      it 'returns the correct path' do
        expect(subject.default_cgibin_dir).to eq '/usr/lib/cgi-bin'
      end
    end
  end
end
