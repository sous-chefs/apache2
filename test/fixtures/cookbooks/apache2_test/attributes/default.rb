...
default['apache_test']['remote_host_ip_unlisted'] = '8.8.8.8'
default['apache_test']['ssl_cert_file'] = "#{node['apache_test']['root_dir']}/server.crt"
default['apache_test']['ssl_cert_key_file'] = "#{node['apache_test']['root_dir']}/server.key"
