...
* `node['apache']['version']` - Specifing 2.4 triggers apache 2.4 support. If your platform is detected as installing 2.4 by default, it will be set to 2.4 for you. Otherwise it falls back to 2.2.
